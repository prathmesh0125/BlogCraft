        ...
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    ...
                    {type === "signup" ? <LabelledInput label="About" type={"textarea"}   rows={5}  placeholder="write smothing about you" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
...
function LabelledInput({ label, placeholder, onChange, type ,rows}: LabelledInputType) {
